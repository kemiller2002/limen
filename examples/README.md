...
suite ([`test/examples.test.ts`](https://github.com/kemiller2002/limen/blob/main/test/examples.test.ts)) against its **own
...
**Start at [01-counter](https://github.com/kemiller2002/limen/tree/main/examples/01-counter).** If you only have five minutes, read
[docs/quick-start.md](https://github.com/kemiller2002/limen/blob/main/docs/quick-start.md) instead.
...
Shared presentation lives in [`examples.css`](https://github.com/kemiller2002/limen/blob/main/examples/examples.css). Nothing in it is
...
[13-anti-patterns.md](https://github.com/kemiller2002/limen/blob/main/docs/13-anti-patterns.md) warns about.

## Per-example guides

| Example | README |
| --- | --- |
| 01 | [Counter](https://github.com/kemiller2002/limen/blob/main/examples/01-counter/README.md) |
| 02 | [Input and form](https://github.com/kemiller2002/limen/blob/main/examples/02-form/README.md) |
| 03 | [Fetch data](https://github.com/kemiller2002/limen/blob/main/examples/03-fetch-data/README.md) |
| 04 | [Save data](https://github.com/kemiller2002/limen/blob/main/examples/04-save-data/README.md) |
| 05 | [Multi-screen](https://github.com/kemiller2002/limen/blob/main/examples/05-multi-screen/README.md) |
...
- [Getting started](https://github.com/kemiller2002/limen/blob/main/docs/02-getting-started.md) — build one from scratch
- [Recipes](https://github.com/kemiller2002/limen/blob/main/docs/15-recipes.md) — task-by-task instructions
