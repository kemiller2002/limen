...
- [13-anti-patterns.md](https://github.com/kemiller2002/limen/blob/main/docs/13-anti-patterns.md) — more wrong/right pairs
- [12-design-rules.md](https://github.com/kemiller2002/limen/blob/main/docs/12-design-rules.md) — MUST/SHOULD/MAY, and how each is enforced
- [14-agent-guide.md](https://github.com/kemiller2002/limen/blob/main/docs/14-agent-guide.md) — the same question, written for agents
