...
[09-testing-and-debugging.md](https://github.com/kemiller2002/limen/blob/main/docs/09-testing-and-debugging.md).
...
This is a known limitation, recorded in [USAGE.md](https://github.com/kemiller2002/limen/blob/main/docs/USAGE.md)'s "Known gaps".
...
Recorded in [USAGE.md](https://github.com/kemiller2002/limen/blob/main/docs/USAGE.md)'s "Known gaps" and
...
[02-getting-started.md](https://github.com/kemiller2002/limen/blob/main/docs/02-getting-started.md).
...
paths. See [clipboard.md](https://github.com/kemiller2002/limen/blob/main/docs/clipboard.md#testing-it).
...
[routing.md](https://github.com/kemiller2002/limen/blob/main/docs/routing.md#the-asymmetry-that-matters).
...
3. Open [`examples/kitchen-sink.html`](https://github.com/kemiller2002/limen/blob/main/examples/kitchen-sink.html) — it has
...
4. Reduce to the smallest reproduction and check it against
   [13-anti-patterns.md](https://github.com/kemiller2002/limen/blob/main/docs/13-anti-patterns.md).
